...
export type AddedToProjectEventKeySpecifier = ('actor' | 'createdAt' | 'databaseId' | 'id' | AddedToProjectEventKeySpecifier)[];
...
export type AnnouncementBannerKeySpecifier = ('announcement' | 'announcementExpiresAt' | 'announcementUserDismissible' | AnnouncementBannerKeySpecifier)[];
...
export type ConvertedNoteToIssueEventKeySpecifier = ('actor' | 'createdAt' | 'databaseId' | 'id' | ConvertedNoteToIssueEventKeySpecifier)[];
...
export type CreateLinkedBranchPayloadKeySpecifier = ('clientMutationId' | 'linkedBranch' | CreateLinkedBranchPayloadKeySpecifier)[];
...
export type DeploymentStatusKeySpecifier = ('createdAt' | 'creator' | 'deployment' | 'description' | 'environmentUrl' | 'id' | 'logUrl' | 'state' | 'updatedAt' | DeploymentStatusKeySpecifier)[];
...
export type EnterpriseKeySpecifier = ('announcement' | 'announcementExpiresAt' | 'announcementUserDismissible' | 'avatarUrl' | 'billingInfo' | 'createdAt' | 'databaseId' | 'description' | 'descriptionHTML' | 'id' | 'location' | 'members' | 'name' | 'organizations' | 'ownerInfo' | 'resourcePath' | 'slug' | 'url' | 'viewerIsAdmin' | 'websiteUrl' | EnterpriseKeySpecifier)[];
...
export type IssueTemplateKeySpecifier = ('about' | 'body' | 'filename' | 'name' | 'title' | IssueTemplateKeySpecifier)[];
...
export type MigrationKeySpecifier = ('continueOnError' | 'createdAt' | 'databaseId' | 'failureReason' | 'id' | 'migrationLogUrl' | 'migrationSource' | 'repositoryName' | 'sourceUrl' | 'state' | MigrationKeySpecifier)[];
...
export type MovedColumnsInProjectEventKeySpecifier = ('actor' | 'createdAt' | 'databaseId' | 'id' | MovedColumnsInProjectEventKeySpecifier)[];
...
export type MutationKeySpecifier = ('abortQueuedMigrations' | 'acceptEnterpriseAdministratorInvitation' | 'acceptTopicSuggestion' | 'addAssigneesToAssignable' | 'addComment' | 'addDiscussionComment' | 'addDiscussionPollVote' | 'addEnterpriseOrganizationMember' | 'addEnterpriseSupportEntitlement' | 'addLabelsToLabelable' | 'addProjectCard' | 'addProjectColumn' | 'addProjectV2DraftIssue' | 'addProjectV2ItemById' | 'addPullRequestReview' | 'addPullRequestReviewComment' | 'addPullRequestReviewThread' | 'addReaction' | 'addStar' | 'addUpvote' | 'addVerifiableDomain' | 'approveDeployments' | 'approveVerifiableDomain' | 'archiveProjectV2Item' | 'archiveRepository' | 'cancelEnterpriseAdminInvitation' | 'cancelSponsorship' | 'changeUserStatus' | 'clearLabelsFromLabelable' | 'clearProjectV2ItemFieldValue' | 'cloneProject' | 'cloneTemplateRepository' | 'closeIssue' | 'closePullRequest' | 'convertProjectCardNoteToIssue' | 'convertPullRequestToDraft' | 'copyProjectV2' | 'createAttributionInvitation' | 'createBranchProtectionRule' | 'createCheckRun' | 'createCheckSuite' | 'createCommitOnBranch' | 'createDiscussion' | 'createEnterpriseOrganization' | 'createEnvironment' | 'createIpAllowListEntry' | 'createIssue' | 'createLinkedBranch' | 'createMigrationSource' | 'createProject' | 'createProjectV2' | 'createPullRequest' | 'createRef' | 'createRepository' | 'createSponsorsListing' | 'createSponsorsTier' | 'createSponsorship' | 'createTeamDiscussion' | 'createTeamDiscussionComment' | 'declineTopicSuggestion' | 'deleteBranchProtectionRule' | 'deleteDeployment' | 'deleteDiscussion' | 'deleteDiscussionComment' | 'deleteEnvironment' | 'deleteIpAllowListEntry' | 'deleteIssue' | 'deleteIssueComment' | 'deleteLinkedBranch' | 'deleteProject' | 'deleteProjectCard' | 'deleteProjectColumn' | 'deleteProjectV2' | 'deleteProjectV2Item' | 'deletePullRequestReview' | 'deletePullRequestReviewComment' | 'deleteRef' | 'deleteTeamDiscussion' | 'deleteTeamDiscussionComment' | 'deleteVerifiableDomain' | 'disablePullRequestAutoMerge' | 'dismissPullRequestReview' | 'dismissRepositoryVulnerabilityAlert' | 'enablePullRequestAutoMerge' | 'followOrganization' | 'followUser' | 'grantEnterpriseOrganizationsMigratorRole' | 'grantMigratorRole' | 'inviteEnterpriseAdmin' | 'linkProjectV2ToRepository' | 'linkProjectV2ToTeam' | 'linkRepositoryToProject' | 'lockLockable' | 'markDiscussionCommentAsAnswer' | 'markFileAsViewed' | 'markPullRequestReadyForReview' | 'mergeBranch' | 'mergePullRequest' | 'minimizeComment' | 'moveProjectCard' | 'moveProjectColumn' | 'pinIssue' | 'publishSponsorsTier' | 'regenerateEnterpriseIdentityProviderRecoveryCodes' | 'regenerateVerifiableDomainToken' | 'rejectDeployments' | 'removeAssigneesFromAssignable' | 'removeEnterpriseAdmin' | 'removeEnterpriseIdentityProvider' | 'removeEnterpriseMember' | 'removeEnterpriseOrganization' | 'removeEnterpriseSupportEntitlement' | 'removeLabelsFromLabelable' | 'removeOutsideCollaborator' | 'removeReaction' | 'removeStar' | 'removeUpvote' | 'reopenIssue' | 'reopenPullRequest' | 'requestReviews' | 'rerequestCheckSuite' | 'resolveReviewThread' | 'retireSponsorsTier' | 'revertPullRequest' | 'revokeEnterpriseOrganizationsMigratorRole' | 'revokeMigratorRole' | 'setEnterpriseIdentityProvider' | 'setOrganizationInteractionLimit' | 'setRepositoryInteractionLimit' | 'setUserInteractionLimit' | 'startOrganizationMigration' | 'startRepositoryMigration' | 'submitPullRequestReview' | 'transferEnterpriseOrganization' | 'transferIssue' | 'unarchiveProjectV2Item' | 'unarchiveRepository' | 'unfollowOrganization' | 'unfollowUser' | 'unlinkProjectV2FromRepository' | 'unlinkProjectV2FromTeam' | 'unlinkRepositoryFromProject' | 'unlockLockable' | 'unmarkDiscussionCommentAsAnswer' | 'unmarkFileAsViewed' | 'unmarkIssueAsDuplicate' | 'unminimizeComment' | 'unpinIssue' | 'unresolveReviewThread' | 'updateBranchProtectionRule' | 'updateCheckRun' | 'updateCheckSuitePreferences' | 'updateDiscussion' | 'updateDiscussionComment' | 'updateEnterpriseAdministratorRole' | 'updateEnterpriseAllowPrivateRepositoryForkingSetting' | 'updateEnterpriseDefaultRepositoryPermissionSetting' | 'updateEnterpriseMembersCanChangeRepositoryVisibilitySetting' | 'updateEnterpriseMembersCanCreateRepositoriesSetting' | 'updateEnterpriseMembersCanDeleteIssuesSetting' | 'updateEnterpriseMembersCanDeleteRepositoriesSetting' | 'updateEnterpriseMembersCanInviteCollaboratorsSetting' | 'updateEnterpriseMembersCanMakePurchasesSetting' | 'updateEnterpriseMembersCanUpdateProtectedBranchesSetting' | 'updateEnterpriseMembersCanViewDependencyInsightsSetting' | 'updateEnterpriseOrganizationProjectsSetting' | 'updateEnterpriseOwnerOrganizationRole' | 'updateEnterpriseProfile' | 'updateEnterpriseRepositoryProjectsSetting' | 'updateEnterpriseTeamDiscussionsSetting' | 'updateEnterpriseTwoFactorAuthenticationRequiredSetting' | 'updateEnvironment' | 'updateIpAllowListEnabledSetting' | 'updateIpAllowListEntry' | 'updateIpAllowListForInstalledAppsEnabledSetting' | 'updateIssue' | 'updateIssueComment' | 'updateNotificationRestrictionSetting' | 'updateOrganizationAllowPrivateRepositoryForkingSetting' | 'updateOrganizationWebCommitSignoffSetting' | 'updateProject' | 'updateProjectCard' | 'updateProjectColumn' | 'updateProjectV2' | 'updateProjectV2DraftIssue' | 'updateProjectV2ItemFieldValue' | 'updateProjectV2ItemPosition' | 'updatePullRequest' | 'updatePullRequestBranch' | 'updatePullRequestReview' | 'updatePullRequestReviewComment' | 'updateRef' | 'updateRepository' | 'updateRepositoryWebCommitSignoffSetting' | 'updateSponsorshipPreferences' | 'updateSubscription' | 'updateTeamDiscussion' | 'updateTeamDiscussionComment' | 'updateTeamsRepository' | 'updateTopics' | 'verifyVerifiableDomain' | MutationKeySpecifier)[];
...
export type OrganizationInvitationKeySpecifier = ('createdAt' | 'email' | 'id' | 'invitationSource' | 'invitationType' | 'invitee' | 'inviter' | 'organization' | 'role' | OrganizationInvitationKeySpecifier)[];
...
export type ProjectV2KeySpecifier = ('closed' | 'closedAt' | 'createdAt' | 'creator' | 'databaseId' | 'field' | 'fields' | 'id' | 'items' | 'number' | 'owner' | 'public' | 'readme' | 'repositories' | 'resourcePath' | 'shortDescription' | 'teams' | 'title' | 'updatedAt' | 'url' | 'view' | 'viewerCanUpdate' | 'views' | 'workflow' | 'workflows' | ProjectV2KeySpecifier)[];
...
export type ProjectV2ItemKeySpecifier = ('content' | 'createdAt' | 'creator' | 'databaseId' | 'fieldValueByName' | 'fieldValues' | 'id' | 'isArchived' | 'project' | 'type' | 'updatedAt' | ProjectV2ItemKeySpecifier)[];
...
export type ProjectV2ItemFieldSingleSelectValueKeySpecifier = ('createdAt' | 'creator' | 'databaseId' | 'field' | 'id' | 'item' | 'name' | 'nameHTML' | 'optionId' | 'updatedAt' | ProjectV2ItemFieldSingleSelectValueKeySpecifier)[];
...
export type ProjectV2SingleSelectFieldOptionKeySpecifier = ('id' | 'name' | 'nameHTML' | ProjectV2SingleSelectFieldOptionKeySpecifier)[];
...
export type ProjectV2ViewKeySpecifier = ('createdAt' | 'databaseId' | 'fields' | 'filter' | 'groupBy' | 'groupByFields' | 'id' | 'layout' | 'name' | 'number' | 'project' | 'sortBy' | 'sortByFields' | 'updatedAt' | 'verticalGroupBy' | 'verticalGroupByFields' | 'visibleFields' | ProjectV2ViewKeySpecifier)[];
...
export type ProjectV2WorkflowKeySpecifier = ('createdAt' | 'databaseId' | 'enabled' | 'id' | 'name' | 'number' | 'project' | 'updatedAt' | ProjectV2WorkflowKeySpecifier)[];
...
export type PullRequestKeySpecifier = ('activeLockReason' | 'additions' | 'assignees' | 'author' | 'authorAssociation' | 'autoMergeRequest' | 'baseRef' | 'baseRefName' | 'baseRefOid' | 'baseRepository' | 'body' | 'bodyHTML' | 'bodyText' | 'changedFiles' | 'checksResourcePath' | 'checksUrl' | 'closed' | 'closedAt' | 'closingIssuesReferences' | 'comments' | 'commits' | 'createdAt' | 'createdViaEmail' | 'databaseId' | 'deletions' | 'editor' | 'files' | 'headRef' | 'headRefName' | 'headRefOid' | 'headRepository' | 'headRepositoryOwner' | 'hovercard' | 'id' | 'includesCreatedEdit' | 'isCrossRepository' | 'isDraft' | 'isReadByViewer' | 'labels' | 'lastEditedAt' | 'latestOpinionatedReviews' | 'latestReviews' | 'locked' | 'maintainerCanModify' | 'mergeCommit' | 'mergeable' | 'merged' | 'mergedAt' | 'mergedBy' | 'milestone' | 'number' | 'participants' | 'permalink' | 'potentialMergeCommit' | 'projectCards' | 'projectItems' | 'projectV2' | 'projectsV2' | 'publishedAt' | 'reactionGroups' | 'reactions' | 'repository' | 'resourcePath' | 'revertResourcePath' | 'revertUrl' | 'reviewDecision' | 'reviewRequests' | 'reviewThreads' | 'reviews' | 'state' | 'suggestedReviewers' | 'timeline' | 'timelineItems' | 'title' | 'titleHTML' | 'totalCommentsCount' | 'updatedAt' | 'url' | 'userContentEdits' | 'viewerCanApplySuggestion' | 'viewerCanDeleteHeadRef' | 'viewerCanDisableAutoMerge' | 'viewerCanEditFiles' | 'viewerCanEnableAutoMerge' | 'viewerCanMergeAsAdmin' | 'viewerCanReact' | 'viewerCanSubscribe' | 'viewerCanUpdate' | 'viewerCannotUpdateReasons' | 'viewerDidAuthor' | 'viewerLatestReview' | 'viewerLatestReviewRequest' | 'viewerMergeBodyText' | 'viewerMergeHeadlineText' | 'viewerSubscription' | PullRequestKeySpecifier)[];
...
export type PullRequestThreadKeySpecifier = ('comments' | 'diffSide' | 'id' | 'isCollapsed' | 'isOutdated' | 'isResolved' | 'line' | 'pullRequest' | 'repository' | 'resolvedBy' | 'startDiffSide' | 'startLine' | 'viewerCanReply' | 'viewerCanResolve' | 'viewerCanUnresolve' | PullRequestThreadKeySpecifier)[];
...
export type RefKeySpecifier = ('associatedPullRequests' | 'branchProtectionRule' | 'compare' | 'id' | 'name' | 'prefix' | 'refUpdateRule' | 'repository' | 'target' | RefKeySpecifier)[];
...
export type RemovedFromProjectEventKeySpecifier = ('actor' | 'createdAt' | 'databaseId' | 'id' | RemovedFromProjectEventKeySpecifier)[];
...
export type RepositoryMigrationKeySpecifier = ('continueOnError' | 'createdAt' | 'databaseId' | 'failureReason' | 'id' | 'migrationLogUrl' | 'migrationSource' | 'repositoryName' | 'sourceUrl' | 'state' | RepositoryMigrationKeySpecifier)[];
...
export type RepositoryVulnerabilityAlertKeySpecifier = ('createdAt' | 'dependabotUpdate' | 'dependencyScope' | 'dismissComment' | 'dismissReason' | 'dismissedAt' | 'dismisser' | 'fixReason' | 'fixedAt' | 'id' | 'number' | 'repository' | 'securityAdvisory' | 'securityVulnerability' | 'state' | 'vulnerableManifestFilename' | 'vulnerableManifestPath' | 'vulnerableRequirements' | RepositoryVulnerabilityAlertKeySpecifier)[];
export type RepositoryVulnerabilityAlertFieldPolicy = {
	...
	fixReason?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type SecurityAdvisoryKeySpecifier = ('classification' | 'cvss' | 'cwes' | 'databaseId' | 'description' | 'ghsaId' | 'id' | 'identifiers' | 'notificationsPermalink' | 'origin' | 'permalink' | 'publishedAt' | 'references' | 'severity' | 'summary' | 'updatedAt' | 'vulnerabilities' | 'withdrawnAt' | SecurityAdvisoryKeySpecifier)[];
...
export type SponsorshipKeySpecifier = ('createdAt' | 'id' | 'isActive' | 'isOneTimePayment' | 'isSponsorOptedIntoEmail' | 'maintainer' | 'privacyLevel' | 'sponsor' | 'sponsorEntity' | 'sponsorable' | 'tier' | 'tierSelectedAt' | SponsorshipKeySpecifier)[];
...
export type SshSignatureKeySpecifier = ('email' | 'isValid' | 'keyFingerprint' | 'payload' | 'signature' | 'signer' | 'state' | 'wasSignedByGitHub' | SshSignatureKeySpecifier)[];
...
export type TeamKeySpecifier = ('ancestors' | 'avatarUrl' | 'childTeams' | 'combinedSlug' | 'createdAt' | 'databaseId' | 'description' | 'discussion' | 'discussions' | 'discussionsResourcePath' | 'discussionsUrl' | 'editTeamResourcePath' | 'editTeamUrl' | 'id' | 'invitations' | 'memberStatuses' | 'members' | 'membersResourcePath' | 'membersUrl' | 'name' | 'newTeamResourcePath' | 'newTeamUrl' | 'organization' | 'parentTeam' | 'privacy' | 'projectV2' | 'projectsV2' | 'repositories' | 'repositoriesResourcePath' | 'repositoriesUrl' | 'resourcePath' | 'slug' | 'teamsResourcePath' | 'teamsUrl' | 'updatedAt' | 'url' | 'viewerCanAdminister' | 'viewerCanSubscribe' | 'viewerSubscription' | TeamKeySpecifier)[];
...
export type WorkflowKeySpecifier = ('createdAt' | 'databaseId' | 'id' | 'name' | 'runs' | 'updatedAt' | WorkflowKeySpecifier)[];
